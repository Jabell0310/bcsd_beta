...
// 더 희한한 점은 var은 카운터 변수도 블록처리를 안하고 엑세스를 한다는 점이다. 함수처리 기반 변수이기 떄문
...
generation1th();
// 랙시컬 범위는 부모 함수안에 자식함수나 for문 같은 것이 있을 때 부모함수의 정보를 자식함수가 엑세스할 수 있고 자식함수의 정보를 부모함수가 엑세스할 수 없다는 범위를 규정한 것이다.
